...
class EmiCalculatorr extends StatefulWidget {
  EmiCalculatorr({super.key});

  final PartPaymentController controller = Get.find<PartPaymentController>();

  @override
  _EmiCalculatorrState createState() => _EmiCalculatorrState();
}

class _EmiCalculatorrState extends State<EmiCalculatorr> {
